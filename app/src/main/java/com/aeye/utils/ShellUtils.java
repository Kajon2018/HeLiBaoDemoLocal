...
//	}
	...
	/**
	 * @param close  1Ϊ�򿪣�0Ϊ�ر�
	 */
	public static void openOrColseM320MaiDi(int close){
		String[] commands1 = new String[]{"echo "+close+" > /sys/devices/platform/maidi_sysfs/zjm_en"};
		CommandResult result1 = ShellUtils.execCommand(commands1, false,true);
		String[] commands2 = new String[]{"echo "+close+" > /sys/devices/platform/maidi_sysfs/camera_en"};
		CommandResult result2 = ShellUtils.execCommand(commands2, false,true);
//		String[] commands3 = new String[]{"echo "+close+" > /sys/devices/platform/maidi_sysfs/card_en"};
//		CommandResult result3 = ShellUtils.execCommand(commands3, false,true);
	} 
}
